...
public class Trabajo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TRABAJO PARA BOMBEO DE AGUA");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/IOS1 (1).png"))); // NOI18N
        jLabel2.setToolTipText("");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/IOS2 (1).png"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Franklin Gothic Heavy", 0, 11)); // NOI18N
        jLabel4.setText("Elija una imagen para hallar el trabajo");
